...
const Modal: React.FC<ModalProps> = ({  children, theme }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center w-screen h-screen bg-black bg-opacity-70 p-4 md:p-8 transition-opacity duration-300 ease-in-out">
      <div
